const m="0.29.4",h=`https://cdn.jsdelivr.net/pyodide/v${m}/full/pyodide.mjs`,f=["numpy","scipy","micropip"],d={LOADING_PYODIDE:"Loading Pyodide...",INSTALLING_DEPS:"Installing NumPy and SciPy..."},p={WORKER_NOT_INITIALIZED:"Worker not initialized",FAILED_TO_LOAD_PYODIDE:"Failed to load Pyodide"},y="https://fast.pathsim.org/wheels/fastsim-0.25.0-cp313-cp313-pyemscripten_2025_0_wasm32.whl";y.match(/fastsim-([0-9][^-/]*)-/)?.[1];var g=`"""Shared package-install primitives for the Pyodide and Flask backends.
